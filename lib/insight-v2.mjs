 ...
 * Active prompt version: recognition-v3.0 (see lib/insight-recognition-v3.mjs)
 * Fallback prompt (unchanged): adaptive-v2.2.1 — SYSTEM_PROMPT_V2 below
...
} from "./insight-recognition-v3.mjs";
...
/** Active runtime prompt for new generations on this feature branch. */
export const INSIGHT_V2_PROMPT_VERSION = INSIGHT_RECOGNITION_V3_PROMPT_VERSION;
/** Preserved V2.2.1 fallback — do not delete or rewrite SYSTEM_PROMPT_V2. */
export const INSIGHT_V2_PROMPT_VERSION_FALLBACK = "adaptive-v2.2.1";
